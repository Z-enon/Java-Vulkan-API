...
/**
 * Defines the queues the application requires, with the same spirit as {@link GPUFeatures}.
 ...
 * @author Zenon
 */
public class QueueFeatures implements Iterable<BiPredicate<VkQueueFamilyProperties, Boolean>>{
     ...
     * for {@link VkSwapChains#create(VulkanBundle, long, XeGPU, VkDevice)} to work properly,
     ...
     */
    public static QueueFeatures recommended() {
        var r = new QueueFeatures(2);
     ...
     * @return a new QueueFeatures object
     */
    public static QueueFeatures custom(int capacity) {
        return new QueueFeatures(capacity);
    }
     ...
     */
    protected QueueFeatures(int capacity) {
