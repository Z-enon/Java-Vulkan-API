...
public final class VkManager {
     ...
     * {@link #init(VkApplicationInfo, VkAllocationCallbacks, Collection, Collection, String, String, GPUFeaturesCreateInfo, QueueFeaturesCreateInfo, VkWindow)}.
     *
    ...
    public static void init(VkApplicationInfo appInfo,
                            ...
                            String GPU_vendor,
                            String GPU_name,
                            GPUFeaturesCreateInfo gpuFeatures,
                            QueueFeaturesCreateInfo queueFeatures,
                            VkWindow window) {
